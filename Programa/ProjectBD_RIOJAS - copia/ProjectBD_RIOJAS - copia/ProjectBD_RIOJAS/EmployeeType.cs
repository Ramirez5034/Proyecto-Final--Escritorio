...
{
    public partial class EmployeeType : MaterialSkin.Controls.MaterialForm
    {
        public EmployeeType()
        {
            InitializeComponent();
        ...
        public DataTable llenar_grid()
        {
            ...
            string consulta = "SELECT * FROM EmployeeType";
        ...
        {
            Conexion.Conectar();
            string insertar = "INSERT INTO EmployeeType (Name,BaseSalary,Hours)VALUES(@Name,@BaseSalary,@Hours)";
            SqlCommand cmd1 = new SqlCommand(insertar, Conexion.Conectar());
            cmd1.Parameters.AddWithValue("@Name", textBox1.Text);
            cmd1.Parameters.AddWithValue("@BaseSalary", textBox2.Text);
            cmd1.Parameters.AddWithValue("@Hours", textBox3.Text);
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                textBox2.Text = dataGridView1.CurrentRow.Cells["BaseSalary"].Value.ToString();
                textBox3.Text = dataGridView1.CurrentRow.Cells["Hours"].Value.ToString();
        ...
        {
            Conexion.Conectar();
            string actualizar = "UPDATE EmployeeType SET " +
                                 "Name=@Name, " +
            ...
            {
                int employeetypeID = ObtenerValorEmployeeIDDesdeFuenteDeDatos();

                cmd2.Parameters.AddWithValue("@EmployeeTypeID", employeetypeID);
                cmd2.Parameters.AddWithValue("@Name", textBox1.Text);
                cmd2.Parameters.AddWithValue("@BaseSalary", textBox2.Text);
                cmd2.Parameters.AddWithValue("@Hours", textBox3.Text);
        ...
        private int ObtenerValorEmployeeIDDesdeFuenteDeDatos()
        {
            ...
            {
                return Convert.ToInt32(dataGridView1.CurrentRow.Cells["EmployeeTypeID"].Value);
            }
            else
            {
        ...
        {
            Conexion.Conectar();
            string eliminar = "DELETE FROM EmployeeType WHERE EmployeeTypeID = @EmployeeTypeID";
            ...
            using (SqlCommand cmd3 = new SqlCommand(eliminar, Conexion.Conectar()))
            {
                ...
                cmd3.Parameters.AddWithValue("@EmployeeTypeID", employeetypeID);
